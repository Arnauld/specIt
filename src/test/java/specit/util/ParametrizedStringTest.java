...
public class ParametrizedStringTest {
    ...
    public void weightChain_noParameter_ex3() {
        ...
        assertThat(chain.tokenize(), equalTo(Collections.<String>emptyList()));
    }
    ...
    public void extractParameterValues_withParameter_insideParameter() {
        ...
        assertThat(values, hasEntry("name", "Travis"));
    }
    ...
    public void extractParameterValues_withNewlines() {
        ...
        Map<String, String> values = s.extractParameterValues(content);
        assertThat(values, hasEntry("name", "Bob"));
        assertThat(values, hasEntry("exampleTable", "\n" +
                "|key|value|\n" +
                "|Login|networkAgentLogin|\n" +
                "|Password|networkAgentPassword|\n"));
    }
